...
/**
 * Merchant dashboard chrome (sidebar + top bar + mobile tab bar).
 * Used by the /_authenticated layout and by signed-in public pages
 * such as /docs so navigation stays available.
 */
