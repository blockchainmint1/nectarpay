...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Nectar.Pay — non-custodial crypto payments for any store" },
      {
      ...
      { name: "twitter:title", content: "Nectar.Pay — non-custodial crypto payments for any store" },
      { name: "description", content: "Nectar.Pay Gateway enables web stores to accept payments in various cryptocurrencies." },
      { property: "og:description", content: "Nectar.Pay Gateway enables web stores to accept payments in various cryptocurrencies." },
      { name: "twitter:description", content: "Nectar.Pay Gateway enables web stores to accept payments in various cryptocurrencies." },
