...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms of Use — payHME" },
      {
        name: "description",
        content:
          "The terms governing use of payHME, a non-custodial crypto payment gateway built for the Honest Money Ecosystem.",
      },
    ],
  }),
  component: TermsPage,
    ...
    <article className="mx-auto max-w-3xl px-6 py-16">
      ...
      <div className="prose prose-neutral mt-10 max-w-none dark:prose-invert">
        <p className="text-base text-muted-foreground">
          This page is maintained by payHME to describe the terms on which we
          provide our merchant payment gateway. Plain English where we can,
          legal language where we must. By creating a payHME account or
          accepting a payment through payHME, you agree to these terms.
        </p>

        <h2>1. What payHME is</h2>
        <p>
          payHME is a <strong>non-custodial</strong> cryptocurrency payment
          ...
          payHME never takes possession of customer funds, and cannot freeze,
        ...
        <ul>
          ...
          <li>
            ...
            abuse the service, or use payHME for activity prohibited by
            applicable law.
          </li>
        </ul>
        ...
        <p>
          ...
          prospectively with reasonable notice. Because payHME is
        ...
        <p>
          ...
          Ethereum, Base, Tron, Solana, and others we may add). payHME does
        ...
        <p>
          payHME does not process refunds. Cryptocurrency payments have no
        ...
        <p>
          ...
          business. payHME provides export tools (CSV, JSON, QuickBooks) to
          help; it does not provide tax or legal advice.
        </p>

        <h2>8. Service availability</h2>
        <p>
          We work to keep payHME available, but we do not guarantee
          ...
          is on-chain, payHME downtime does not put your funds at risk.
        </p>

        <h2>9. Acceptable use</h2>
        <p>
          You agree not to use payHME for activity that is illegal under
        ...
        <p>
          payHME is provided <strong>"as is"</strong> without warranties of
        ...
        <p>
          To the maximum extent permitted by law, payHME's total liability
