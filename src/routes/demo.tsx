          ...
          <div className="flex items-center justify-center rounded-2xl border border-border bg-card/60 p-10 text-center">
            <div>
              ...
              <Button asChild variant="outline" className="mt-6">
                <a href="https://blockchainmint.com/buy/nectar-pay-mobile-pos-terminal?to=cart&variant=40cc988e-8a2c-4b39-95af-75bc57024301&clear=1" target="_blank" rel="noreferrer">Or grab your kit now →</Link>
              </Button>
            </div>
          </div>
        ) : (
